drop table if exists export.adm_raw_export_h1_lstm_v1;
select
--  top 100
  ...
  price_2avg,
  lable_h1_price_2avg
into export.adm_raw_export_h1_lstm_v1
...
where   year(a.pricedate) in (2017,2018) and lable_h1_price_2avg is not null
