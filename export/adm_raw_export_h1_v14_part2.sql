drop table IF EXISTS export.adm_raw_export_h1_v14_part2;
...
into export.adm_raw_export_h1_v14_part2
...
FROM adm.h1_price_h1 as t1
      ...
      LEFT OUTER JOIN adm.h1_price_ki_h1 as t8
            on t1.currency=t8.currency and t1.pricedate=t8.pricedate and t1.pricetime=t8.pricetime
      LEFT OUTER JOIN adm.h1_price_ki_d1 as t9
            on t1.currency=t9.currency and t1.pricetime=t9.pricetime and t1.pricedate=t9.pricedate
