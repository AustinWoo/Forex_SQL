...
drop table IF EXISTS adm.m5_lable;
...
select
  ...
  b1.closebid-a.closebid as trend_gap_m5_1,
  b2.closebid-a.closebid as trend_gap_m5_2,
  b3.closebid-a.closebid as trend_gap_m5_3,
  b4.closebid-a.closebid as trend_gap_m5_4,
  b5.closebid-a.closebid as trend_gap_m5_5,
  b6.closebid-a.closebid as trend_gap_m5_6

INTO adm.m5_lable
from forex.dwd_price_bid_m5 a

  LEFT OUTER JOIN forex.dwd_price_bid_m5 b1
    on a.currency=b1.currency and a.r=b1.r-1

  LEFT OUTER JOIN forex.dwd_price_bid_m5 b2
    on a.currency=b2.currency and a.r=b2.r-2

  LEFT OUTER JOIN forex.dwd_price_bid_m5 b3
    on a.currency=b3.currency and a.r=b3.r-3

  LEFT OUTER JOIN forex.dwd_price_bid_m5 b4
    on a.currency=b4.currency and a.r=b4.r-4

  LEFT OUTER JOIN forex.dwd_price_bid_m5 b5
    on a.currency=b5.currency and a.r=b5.r-5

  LEFT OUTER JOIN forex.dwd_price_bid_m5 b6
